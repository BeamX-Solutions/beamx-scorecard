                        ...
                        <table width="600" cellpadding="0" cellspacing="0" style="background-color: #f5f5f5;">
                            ...
                            <tr>
                                <td style="background-color: #02428e; padding: 24px 20px; text-align: center;">
                                    ...
                                    <!-- Social Icons - Updated Version -->
                                    <table cellpadding="0" cellspacing="0" align="center" style="margin: 0 0 32px 0;">
                                        <tr>
                                            <!-- Facebook -->
                                            <td style="padding: 0 8px;">
                                                <a href="https://facebook.com/beamxsolutions" target="_blank" style="display: inline-block; text-decoration: none; border: none;">
                                                    <img src="https://cdn.jsdelivr.net/gh/simple-icons/simple-icons@develop/icons/facebook.svg" width="24" height="24" alt="Facebook" style="display: block; width: 24px; height: 24px; background-color: #ffffff; border-radius: 4px; padding: 8px;" />
                                                </a>
                                            </td>
                                            <!-- Instagram -->
                                            <td style="padding: 0 8px;">
                                                <a href="https://instagram.com/beamxsolutions" target="_blank" style="display: inline-block; text-decoration: none; border: none;">
                                                    <img src="https://cdn.jsdelivr.net/gh/simple-icons/simple-icons@develop/icons/instagram.svg" width="24" height="24" alt="Instagram" style="display: block; width: 24px; height: 24px; background-color: #ffffff; border-radius: 4px; padding: 8px;" />
                                                </a>
                                            </td>
                                            <!-- Twitter/X -->
                                            <td style="padding: 0 8px;">
                                                <a href="https://twitter.com/beamxsolutions" target="_blank" style="display: inline-block; text-decoration: none; border: none;">
                                                    <img src="https://cdn.jsdelivr.net/gh/simple-icons/simple-icons@develop/icons/x.svg" width="24" height="24" alt="X (Twitter)" style="display: block; width: 24px; height: 24px; background-color: #ffffff; border-radius: 4px; padding: 8px;" />
                                                </a>
                                            </td>
                                            <!-- LinkedIn -->
                                            <td style="padding: 0 8px;">
                                                <a href="https://linkedin.com/company/beamxsolutions" target="_blank" style="display: inline-block; text-decoration: none; border: none;">
                                                    <img src="https://cdn.jsdelivr.net/gh/simple-icons/simple-icons@develop/icons/linkedin.svg" width="24" height="24" alt="LinkedIn" style="display: block; width: 24px; height: 24px; background-color: #ffffff; border-radius: 4px; padding: 8px;" />
                                                </a>
                                            </td>
                                        </tr>
                                    </table>
